...
<body>
            ...
            <div class="service-selector">
                ...
                <ul class="service-list">
                    <li class="service-item">
                        ...
                        <span class="service-label">Pain Relief Massage</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/men stress-relife.png" alt="Facial" class="icon-image" />
                        </div>
                        <span class="service-label">Stress Relief Massage</span>
                    </li>
    ...
    <div class="women-all_service-add-card">
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'men_pain_relief'");
            $stmt->execute();
        ...
        <h2>Stress Relief Massage</h2>
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'men_stress_relief'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
