...
<body>
                ...
                <ul class="service-list">
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/32.png" alt="Massage" class="icon-image" />
                        </div>
                        <span class="service-label">Waxing</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/35.png" alt="Facial" class="icon-image" />
                        </div>
                        <span class="service-label">Threading & face-waxing</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/36.png" alt="Manicure" class="icon-image" />
                        </div>
                        <span class="service-label">Cleanup</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/39.png" alt="Hair cut" class="icon-image" />
                        </div>
                        <span class="service-label">Facial</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/46.png" alt="Clean" class="icon-image" />
                        </div>
                        <span class="service-label">Hair, bleach & de-tan</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/manicure.png" alt="Stress relief" class="icon-image" />
                        </div>
                        <span class="service-label">Pedicure & manicure</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="women-all_service-add-card">
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_waxing'");
            $stmt->execute();
        ...
        <h2>Threading & Face-waxing</h2>
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_threading_and_face_waxing'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_cleanup'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_facial'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <h2>Hair, Bleach & De-tan</h2>
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_hair_bleach_detan'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'women_pedicure_manicure'");
            $stmt->execute();
            $services = $stmt->fetchAll(PDO::FETCH_ASSOC);
