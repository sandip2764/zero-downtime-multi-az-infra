...
<head>
    ...
    <title>Home Clean & Pest Control - Karfect</title>
...
<body>
                ...
                <ul class="service-list">
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/pain-relief-men.png" alt="Massage" class="icon-image" />
                        </div>
                        <span class="service-label">Massage</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/facewaxing & threading.png" alt="Facial" class="icon-image" />
                        </div>
                        <span class="service-label">Facial</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/manicure.png" alt="Manicure" class="icon-image" />
                        </div>
                        <span class="service-label">Manicure</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/haircut & beard styling.png" alt="Hair cut" class="icon-image" />
                        </div>
                        <span class="service-label">Hair cut</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/full_home.png" alt="Clean" class="icon-image" />
                        </div>
                        <span class="service-label">Clean</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/men stress-relife.png" alt="Stress relief" class="icon-image" />
                        </div>
                        <span class="service-label">Stress relief</span>
                    </li>
                    <li class="service-item">
                        <div class="service-icon">
                            <img src="<?php echo BASE_PATH; ?>assets/images/cleanup.png" alt="Cleanup" class="icon-image" />
                        </div>
    ...
    <div class="women-all_service-add-card">
        <h2>Room, bathroom & toilet cleaning</h2>
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'home_cleaning_services'");
        ...
        <div class="all_service-card">
            <?php
            $stmt = $conn->prepare("SELECT * FROM services WHERE category = 'pest_control'");
